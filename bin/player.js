class Player extends Entity {
    ...
    constructor(x, y, maxHitpoints) {
        ...
        // Hitbox variables
        this.hitboxes.push(new Hitbox(-13, 50, 30, 80, CollisionType.Overlapping, this));
        this.hitboxes.push(new Hitbox(-20, 50, 40, 85, CollisionType.Colliding, this));
    }
    onGameEngineDefined() {
    ...
    update() {
        ...
        // Animation logic
        const animationOrientation = (this.isDashAnimating) ? this.dashOrientation : this.orientation;
    ...
    movement() {
        ...
        if (this.isDashing) {
            // calculate speed
            const dashAmount = this.dashSpeed * deltaTime * this.dashOrientation;
            // apply dash
